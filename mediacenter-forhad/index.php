...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper">
            <!-- ============================================================= TOP NAVIGATION ============================================================= -->
            <nav class="top-bar animate-dropdown" style="background-color: #9acfea">
                <div class="container">
                    <div class="col-xs-12 col-sm-6 no-margin">
                        <ul>
                            <li><a href="index.php?f=home">Home</a></li>
                            <li><a href="index.php?f=blog">Blog</a></li>
                            <li><a href="index.php?f=faq">FAQ</a></li>
                            <li><a href="index.php?f=contact">Contact</a></li>
                            <li><a href="index.php?f=about_us">About Us</a></li>
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#pages">Pages</a>
                                <ul class="dropdown-menu" role="menu">
                                    <li><a href="index.php?f=home">Home</a></li>
                                    <li><a href="index.php?f=category-grid">Category - Grid/List</a></li>
                                    <li><a href="index.php?f=category-grid-2">Category 2 - Grid/List</a></li>
                                    <li><a href="index.php?f=single-product">Single Product</a></li>
                                    <li><a href="index.php?f=single-product-sidebar">Single Product with Sidebar</a></li>
                                    <li><a href="index.php?f=cart">Shopping Cart</a></li>
                                    <li><a href="index.php?f=checkout">Checkout</a></li>
                                    <li><a href="index.php?f=about_us">About Us</a></li>
                                    <li><a href="index.php?f=contact">Contact Us</a></li>
                                    <li><a href="index.php?f=blog">Blog</a></li>
                                    <li><a href="index.php?f=blog_full_wide">Blog Full Width</a></li>
                                    <li><a href="index.php?f=blog-post">Blog Post</a></li>
                                    <li><a href="index.php?f=faq">FAQ</a></li>
                                    <li><a href="index.php?f=terms">Terms & Conditions</a></li>
                                    <?php
                                    if (isset($_SESSION['id'])) {
                                        echo '<li><a href="index.php?f=logout">Logout</a></li>';
                                        echo '<li><a href="index.php?u=profile">Profile</a></li>';
                                    } else {
                                        echo '<li><a href="index.php?f=login">Login</a></li>';
                                        echo'<li><a href="index.php?f=register">Register</a></li>';
                                    }
                                    ?>
                                </ul>
                            </li>
                    ...
                    <div class="col-xs-12 col-sm-6 no-margin">
                        <ul class="right">
                            ...
                            if (isset($_SESSION['type']) && ($_SESSION['type'] == 2 || $_SESSION['type'] == 3)) {
                                ?>
                                <li class="dropdown">
                                    <a class="dropdown-toggle"  data-toggle="dropdown" href="#">Management</a>
                                    <ul class="dropdown-menu" role="menu">
                                        <?php
                                        if ($_SESSION['type'] == 3) {
                                            echo '<li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?a=authority">Authority</a></li>';
                                        }
                                        ?>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?e=category">Category</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?e=subcategory">Subcategory</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?e=color">Color</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?e=payment">Payment</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?e=size">Size</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?e=country">Country</a></li> 
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?e=product-upload">Product-upload</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?e=delivery">Delivery</a></li>
                                        <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?e=shipping">Shipping</a></li>
                                    </ul>
                                </li>
                                ...
                                <div class="control-group">
                                    ...
                                    <ul class="categories-filter animate-dropdown">
                                        <li class="dropdown">
                                            ...
                                            <a class="dropdown-toggle"  data-toggle="dropdown" href="index.php?f=category-grid">all categories</a>

                                            <ul class="dropdown-menu" role="menu" >
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?f=category-grid">laptops</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?f=category-grid">tv & audio</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?f=category-grid">gadgets</a></li>
                                                <li role="presentation"><a role="menuitem" tabindex="-1" href="index.php?f=category-grid">cameras</a></li>
                                            ...
                                            <div class="basket-item">
                                                <div class="row">
                                                    <div class="col-xs-12 col-sm-6">
                                                        <a href="index.php?f=cart" class="le-button inverse">View cart</a>
                                                    </div>
                                                    <div class="col-xs-12 col-sm-6">
                                                        <a href="index.php?f=chakeout" class="le-button">Checkout</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </li>
            ...
            <footer id="footer" class="color-bg">
                                ...
                                <div class="body">
                                    <ul>
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-9 no-margin">
                                                    <a href="index.php?f=single-product">Netbook Acer Travel B113-E-10072</a>
                                                    <div class="price">
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-9 no-margin">
                                                    <a href="index.php?f=single-product">PowerShot Elph 115 16MP Digital Camera</a>
                                                    <div class="price">
                                                        <div class="price-prev">$2000</div>
                                                        <div class="price-current">$1873</div>
                                                    </div>
                                ...
                                <div class="body">
                                    <ul>
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-9 no-margin">
                                                    <a href="index.php?f=single-product">HP Scanner 2910P</a>
                                                    <div class="price">
                                                        <div class="price-prev">$2000</div>
                                                        <div class="price-current">$1873</div>
                                                    </div>
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-9 no-margin">
                                                    <a href="index.php?f=single-product">Galaxy Tab 3 GT-P5210 16GB, Wi-Fi, 10.1in - White</a>
                                                    <div class="price">
                                                        <div class="price-prev">$2000</div>
                                                        <div class="price-current">$1873</div>
                                                    </div>
                                ...
                                <div class="body">
                                    <ul>
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-9 no-margin">
                                                    <a href="index.php?f=single-product">Galaxy Tab GT-P5210, 10" 16GB Wi-Fi</a>
                                                    <div class="price">
                                                        <div class="price-prev">$2000</div>
                                                        <div class="price-current">$1873</div>
                                                    </div>
                                        ...
                                        <li>
                                            <div class="row">
                                                <div class="col-xs-12 col-sm-9 no-margin">
                                                    <a href="index.php?f=single-product">Surface RT 64GB, Wi-Fi, 10.6in - Dark Titanium</a>
                                                    <div class="price">
                                                        <div class="price-prev">$2000</div>
                                                        <div class="price-current">$1873</div>
                                                    </div>
                        ...
                        <div class="col-xs-12 col-md-8 no-margin">
                            ...
                            <div class="link-widget">
                                <div class="widget">
                                    <h3>Find it fast</h3>
                                    <ul>
                                        <li><a href="index.php?f=category-grid">laptops &amp; computers</a></li>
                                        <li><a href="index.php?f=category-grid">Cameras &amp; Photography</a></li>
                                        <li><a href="index.php?f=category-grid">Smart Phones &amp; Tablets</a></li>
                                        <li><a href="index.php?f=category-grid">Video Games &amp; Consoles</a></li>
                                        <li><a href="index.php?f=category-grid">TV &amp; Audio</a></li>
                                        <li><a href="index.php?f=category-grid">Gadgets</a></li>
                                        <li><a href="index.php?f=category-grid">Car Electronic &amp; GPS</a></li>
                                        <li><a href="index.php?f=category-grid">Accesories</a></li>
                                    </ul>
                                </div><!-- /.widget -->
                            </div><!-- /.link-widget -->
                            ...
                            <div class="link-widget">
                                <div class="widget">
                                    <h3>Information</h3>
                                    <ul>
                                        <li><a href="index.php?f=category-grid">Find a Store</a></li>
                                        <li><a href="index.php?f=category-grid">About Us</a></li>
                                        <li><a href="index.php?f=category-grid">Contact Us</a></li>
                                        <li><a href="index.php?f=category-grid">Weekly Deals</a></li>
                                        <li><a href="index.php?f=category-grid">Gift Cards</a></li>
                                        <li><a href="index.php?f=category-grid">Recycling Program</a></li>
                                        <li><a href="index.php?f=category-grid">Community</a></li>
                                        <li><a href="index.php?f=category-grid">Careers</a></li>
                            ...
                            <div class="link-widget">
                                <div class="widget">
                                    <h3>Information</h3>
                                    <ul>
                                        <li><a href="index.php?f=category-grid">My Account</a></li>
                                        <li><a href="index.php?f=category-grid">Order Tracking</a></li>
                                        <li><a href="index.php?f=category-grid">Wish List</a></li>
                                        <li><a href="index.php?f=category-grid">Customer Service</a></li>
                                        <li><a href="index.php?f=category-grid">Returns / Exchange</a></li>
                                        <li><a href="index.php?f=category-grid">FAQs</a></li>
                                        <li><a href="index.php?f=category-grid">Product Support</a></li>
                                        <li><a href="index.php?f=category-grid">Extended Service Plans</a></li>
                                    </ul>
                                </div><!-- /.widget -->
                            </div><!-- /.link-widget -->
                ...
                <div class="copyright-bar">
                    <div class="container">
                        <div class="col-xs-12 col-sm-6 no-margin">
                            <div class="copyright">
                                &copy; <a href="index.php?f=home">Media Center</a> - all rights reserved
                            </div><!-- /.copyright -->
                        </div>
                        <div class="col-xs-12 col-sm-6 no-margin">
